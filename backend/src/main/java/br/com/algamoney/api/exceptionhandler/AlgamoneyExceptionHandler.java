...
public class AlgamoneyExceptionHandler extends ResponseEntityExceptionHandler {
	...
	/**
	 * Tratando exceptions que não conseguiu lê de algum atributo
	 */
	@Override
	...
	/**
	 * Tratando exceptions quando o argumento não é válido
	 */
	@Override
	...
	/**
	 * Quando deletar/buscar/atualizar e não encontrar o recurso
	 */
	...
	/**
	 * Tentando cadastrar em Lancamentos um ID de Categoria que não existe por exemplo
	 */
